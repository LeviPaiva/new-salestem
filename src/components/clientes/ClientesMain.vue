<template>
  ...
  import jsonData from './ClienteData.json'; // Importar o arquivo JSON com os dados
  ...
  export default defineComponent({
    ...
    created() {
      const dadosLocalStorage = localStorage.getItem('tabelaDadosCliente');
    ...
    methods: {
      salvarLocalStorage() {
        localStorage.setItem('tabelaDadosCliente', JSON.stringify(this.items));
      },
